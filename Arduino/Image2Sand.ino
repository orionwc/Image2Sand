...
Positions drawPictureStep(Positions pointList[], int nodes, Positions current)
{
  ...
  Positions startPoint = { (int)(pointList[start].radial * (float)MAX_R_STEPS/1000), (int)convertDegreesToSteps((float)(pointList[start].angular)/10) };
  Positions endPoint = { (int)(pointList[end].radial * (float)MAX_R_STEPS/1000), (int)convertDegreesToSteps((float)(pointList[end].angular)/10) };
...
Positions pattern_Picture(Positions current, bool restartPattern = false) {
  Positions pointList[] = {
    ...
    // Eagle
    {624,1549},{629,1534},{604,1535},{576,1677},{554,1664},{556,1827},{602,1878},{565,1871},{568,1893},{607,1940},{675,1934},{751,1969},{836,2043},{814,2054},{881,2131},{862,2135},{862,2147},{822,2142},{850,2179},{811,2185},{876,2242},{899,2280},{774,2236},{857,2300},{946,2381},{740,2367},{885,2471},{893,2492},{643,2546},{644,2579},{746,2633},{755,2654},{731,2681},{607,2761},{714,2766},{803,2798},{767,2801},{818,2817},{782,2822},{656,2926},{922,2914},{935,2933},{923,2950},{839,2977},{967,2992},{995,3012},{947,3059},{1000,3082},{990,3116},{925,3169},{832,3205},{943,3194},{962,3217},{916,3260},{827,3294},{818,3325},{619,3437},{537,3442},{370,3514},{249,283},{286,416},{354,456},{344,433},{361,434},{361,407},{405,426},{401,399},{421,411},{537,385},{618,328},{673,277},{768,248},{727,157},{775,183},{826,226},{879,302},{891,351},{885,403},{848,484},{866,503},{870,578},{874,668},{873,758},{862,849},{862,849},{844,880},{830,875},{813,942},{798,941},{757,1156},{738,1132},{738,1195},{729,1203},{720,1185},{715,1228},{700,1227},{694,1353},{672,1372},{660,1332}
