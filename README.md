...
* Using Level 3 of the [HackPack IDE](https://ide.crunchlabs.com) for the Sand Garden, update the code on the Arduino. You can either copy/paste this code, or make the specific changes to the base code shown [here](https://github.com/orionwc/Image2Sand/compare/edd2861..8b99467). Deploy it to the Arduino.
