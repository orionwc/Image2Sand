...
Positions drawPictureStep(Positions pointList[], int nodes, Positions current)
{
  ...
  Positions startPoint = { (int)((float)pointList[start].radial * (float)MAX_R_STEPS / 1000), (int)convertDegreesToSteps((float)((5400 - pointList[start].angular) % 3600)/10) };
  Positions endPoint = { (int)((float)pointList[end].radial * (float)MAX_R_STEPS / 1000), (int)convertDegreesToSteps((float)((5400 - pointList[end].angular) % 3600)/10) };
