...
/**
 * @brief Helper function to read LEDpos from PROGMEM
 * 
 * @param ledPointList Pointer to LEDpos array in PROGMEM
 * @param index Index of the LEDpos to read
 * @return LEDpos The LEDpos struct read from PROGMEM
 */
LEDpos readLEDposFromPROGMEM(const LEDpos *ledPointList, int index) {
  LEDpos result;
  // Read Positions struct (radial and angular)
...
#if USE_LED_CIRCLE && ENABLE_CUSTOM_PATTERN
/**
